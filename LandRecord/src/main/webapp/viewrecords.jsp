...
<script>
	function populateDropdowns() {
		...
		if (selectedState === "TamilNadu") {
			...
			populateDropdown(districtDropdown, [ "--Select District--",
					"Belgaum", "Mysore", "Shivamogga", "Mandya" ]);
		}
		...
		document.getElementById("taluk").addEventListener(
				...
				function() {
					...
					if (selectedTaluk === "Palladam") {
						populateDropdown(hobliDropdown, [ "--Select hobli--",
								"Arjothi Nagar", "Palladam" ]);
					} else if (selectedTaluk === "Pollachi") {
						populateDropdown(hobliDropdown, [ "--Select hobli--",
								"Achipatti", "Alagirichettipalayam" ]);
					} else if (selectedTaluk === "Mettupalayam") {
						populateDropdown(hobliDropdown, [ "--Select hobli--",
								"Akkaraisengapalli", "Alancombu" ]);
					} else if (selectedTaluk === "Udamalpet") {
						populateDropdown(hobliDropdown, [ "--Select hobli--",
								"Amandakadavoo", "Amaravathi Nagar" ]);
					}
					// Dharmapuri
					else if (selectedTaluk === "Harur") {
						populateDropdown(hobliDropdown, [ "--Select hobli--",
								"Naripalli", "ThirathaMalai" ]);
					} else if (selectedTaluk === "Palacode") {
						populateDropdown(hobliDropdown, [ "--Select hobli--",
								"Theerthagiri Nagar", "Begarahalli" ]);
					} else if (selectedTaluk === "Dharmapuri") {
						populateDropdown(hobliDropdown, [ "--Select hobli--",
								"A Gollahalli", "A Jettihalli" ]);
					} else if (selectedTaluk === "Pennagaram") {
						populateDropdown(hobliDropdown, [ "--Select hobli--",
								"Adagapadi", "Ajjanahalli" ]);
					}
					// Karnataka
						...
						function() {
							...
							if (selectedhobli === "Naripalli") {
								populateDropdown(villageDropdown, [
										"--Select Village--",
										"Venkatramapuram", "Kottapatti" ]);
							} else if (selectedhobli === "ThirathaMalai") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Kurumpatty",
										"Andiyur" ]);
							} else if (selectedhobli === "Theerthagiri Nagar") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "K.G.M Hospital",
										"Mayura Street" ]);
								...
								populateDropdown(villageDropdown, [
										"--Select Village--", "Velipettai ST",
										"Valampuri Vinayagar" ]);
							} else if (selectedhobli === "A Jettihalli") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Vankatampatti",
										"Oddapatti" ]);
							...
							// Karnataka villages
								...
								populateDropdown(villageDropdown, [
										"--Select Village--", "Amruta",
										"Anegadde", "Billodi", "Borikoppa" ]);
							} else if (selectedhobli === "Nagara") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Andagaduduru",
										"Baise", "Kabale", "Kadigeri" ]);
							} else if (selectedhobli === "Agrahara") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Agalabagilu",
										"Agasadi", "Aluru", "Aralasurali" ]);
							} else if (selectedhobli === "Agumbe") {
								populateDropdown(villageDropdown,
										[ "--Select Village--", "Arehalli",
												"Balehalli", "Chakkodabilu",
												"Changara" ]);
							} else if (selectedhobli === "Anandapura") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Achapura",
										"Aduru", "Atavdi", "Ballibyelu" ]);
							} else if (selectedhobli === "Avinahalli") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Ambaragodlu",
										"Araleekoppa", "Besuru", "Devasa" ]);
							} else if (selectedhobli === "Jade") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Aretalagadde",
										"Banksana", "Bankavalli", "Bilagali" ]);
							} else if (selectedhobli === "Ulavi") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Avalagodu",
										"Balagodu", "Barige", "Bhadrapura" ]);
							} else if (selectedhobli === "Akkihebbal") {
								populateDropdown(villageDropdown,
										[ "--Select Village--", "Aipanahalli",
												"Akkihebbal", "Alambadi",
												"Alenahalli" ]);
							} else if (selectedhobli === "Bukinakere") {
								populateDropdown(villageDropdown,
										[ "--Select Village--", "Agasarahalli",
												"Aichanahalli", "Aralakuppe",
												"Attuppe" ]);
							} else if (selectedhobli === "Ataguru Hobli") {
								populateDropdown(villageDropdown, [
										"--Select Village--",
										"Alanshettihalli", "Ankanathapura",
										"Ataguru", "Byaladakere" ]);
							} else if (selectedhobli === "Koppa Hobali") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Bekkalale",
										"Bolare", "Hosagali", "Kiranguru" ]);
							} else if (selectedhobli === "Belluru") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Adakatahalli",
										"Agachahalli", "Ambalajeerahalli",
										"Anakanahalli" ]);
							} else if (selectedhobli === "Bindiganaville") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "A Chennapura",
										"A Nagattihalli", "Addihalli",
										"Aleesandra" ]);
							} else if (selectedhobli === "Chinakurali") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Alphalli",
										"Antanahalli", "Aralakuppe",
										"Aralakuppenala" ]);
							} else if (selectedhobli === "Melukote") {
								populateDropdown(villageDropdown,
										[ "--Select Village--", "Amruthi",
												"Anunahalli", "Anuvallu",
												"Arakanakere" ]);
							} else if (selectedhobli === "Kasaba") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Bogadi",
										"Goruru", "Kesare", "Satagalli" ]);
							} else if (selectedhobli === "Varuna") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Dandikere",
										"Hongate", "Marashe", "Yadakola" ]);
							} else if (selectedhobli === "Antarasante") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Anagatti",
										"Anemala", "Hosuru", "Jiyara" ]);
							} else if (selectedhobli === "Hampapura") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Bettahalli",
										"Devalapura", "Karigala", "Pura" ]);
							} else if (selectedhobli === "Bilikere") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Asvalu",
										"Dallalu", "Madlapura", "Tippuru" ]);
							} else if (selectedhobli === "Gavadagere") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Agrahara",
										"Attiguppe", "Belatturu", "Harave" ]);
							} else if (selectedhobli === "Chikkayyanachatra") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Adakananahalli",
										"Alatturu", "Basavanapura",
										"Bidaragudu" ]);
							} else if (selectedhobli === "Hullahalli") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Akala",
										"Amakalli", "Ambale", "Ariyuru" ]);
							} else if (selectedhobli === "Kudachi") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Kudachi",
										"Moraba", "Mugalakhoda", "Neelaji" ]);
							} else if (selectedhobli === "Raybaga") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Bavachi",
										"Chinchali", "Devanakatti", "Jodatti" ]);
							} else if (selectedhobli === "Gokak") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Balobal",
										"Budihala", "Dandapur", "Gokaka" ]);
							} else if (selectedhobli === "Kowjalagi") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Adibatti",
										"Betageri", "Kandratti", "Mannikeri" ]);
							} else if (selectedhobli === "K Chandaragi") {
								populateDropdown(villageDropdown,
										[ "--Select Village--", "Beedaki",
												"Bhagojikoppa", "Bijagupi",
												"Budanura" ]);
							} else if (selectedhobli === "Katakola") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Aribenchi",
										"Bannura", "Bochabala", "Chilamura" ]);
							} else if (selectedhobli === "Beedi") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Adi",
										"Balagunda", "Beedi", "Bhuranaki" ]);
							} else if (selectedhobli === "Gunji") {
								populateDropdown(villageDropdown, [
										"--Select Village--", "Abanalle",
										"Akralli", "Ambevadi", "Anagadi" ]);
							}
			...
			<div class="form-row">
				<div class="col">
					<label class="form-lbl">State:</label> <select class="form-control"
						name="state" id="state" onchange="populateDropdowns()"
						aria-placeholder="Select State" required>
				...
				<div class="col">
					...
					<label for="taluk" class="form-lbl">Taluk:</label> <select
						name="taluk" id="taluk" class="form-control"
						aria-placeholder="Select Taluk">
				...
				<div class="col">
					<label for="hobli" class="form-lbl">Hobli:</label> <select
						name="hobli" id="hobli" class="form-control"
						aria-placeholder="Select Hobli">
				...
				<div class="col">
					...
					<label for="village" class="form-lbl">Village:</label> <select
						name="village" id="village" class="form-control"
						aria-placeholder="Select Village">
						...
						<option value="Saniyoor Sai Mariyamman temple">Saniyoor
							Sai Mariyamman temple</option>
						...
						<option value="Dr BR Ambadkar Colony">Dr BR Ambadkar
							Colony</option>
						<option value="KMK Temple Colony">KMK Temple Colony</option>
						<option value="Kodukkaattai">Kodukkaattai</option>
						<option value="Muniyappan Temple Street">Muniyappan
							Temple Street</option>
						...
						<option value="Old Vinayagar Temple Street">Old Vinayagar
							Temple Street</option>
						<option value="Achipatti RamaSamy">Achipatti RamaSamy</option>
						<option value="Sulakkal Rode">Sulakkal Rode</option>
						<option value="Pechi Ammman Temple Street">Pechi Ammman
							Temple Street</option>
						...
						<option value="Thirupathi Venkatachalapathi Temple">Thirupathi
							Venkatachalapathi Temple</option>
		...
		<tbody>
			<c:forEach var="list" items="${read}">
				<tr>
					...
					<td>${list.year}</td>
					<td> <a class="btn btn-primary" href="editRecords?houseNumber=${list.houseNumber}&surveyNumber=${list.surveyNumber}" role="button" style="  padding-left: 40 px; padding-right: 20px;"  >  &nbsp;&nbsp; Edit  </a>
 </td>
					<td>
						<form action="delete" method="post">
							<input type="hidden" name="houseNumber"
								value="${list.houseNumber}"> <input type="hidden"
								name="surveyNumber" value="${list.surveyNumber}">
